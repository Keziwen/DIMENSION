...
def evaluate(test_data, mask, model_save_path, model_file):
    with tf.Graph() .as_default() as g:
        ...
        y, block_k_1, block_k_2, block_k_3, block_k_4 = inference.inference(mask_p, kspace_p, None)
...
def main(argv=None):
    ...
    model_file = "model_K5C3_D5C2_TV_iso_e-8_ComplexConv_kLoss1-3_e-4_e-4_e-4_block1-2_e+3"
